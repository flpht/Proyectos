...
function pagarClicked() {
    ...
    var totalNumber = parseFloat(total.replace('$', '').replace('.', ''));
    
    var buyOrder = 'orden_' + Math.floor(Math.random() * 1000000);
    var sessionId = 'sesion_' + Math.floor(Math.random() * 1000000);
    var amount = totalNumber;
